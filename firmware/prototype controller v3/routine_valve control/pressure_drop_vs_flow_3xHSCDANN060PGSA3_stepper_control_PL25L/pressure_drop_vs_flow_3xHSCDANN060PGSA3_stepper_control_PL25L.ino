...
void loop() 
{
  ...
  if(flag_read_sensor)
  {
    ...
    if (ret_sfm3000_1 == 0 ) 
      mFlow_1 = sfm3000_1.get_flow();
    if (ret_sfm3000_2 == 0 ) 
      mFlow_2 = sfm3000_2.get_flow();

    mPressure_1 = abp_30psi_1.pressure();
    mPressure_2 = abp_30psi_2.pressure();
    mPressure_3 = abp_5psi_1.pressure();
  ...
  // close the valve
  if (flag_close_valve1_in_progress && ret_sfm3000_1 == 0)
  {
    if(mFlow_1 >= 0.2)
    {
    ...
    {
      if(flag_valve1_flow_detected && mFlow_1 < 0.2)
      {
        X_commanded_target_position = (stepper_X.currentPosition()+1);
  ...
  if (flag_close_valve2_in_progress && ret_sfm3000_1 == 0)
  {
    if(mFlow_1 >= 0.2)
    {
      flag_valve1_flow_detected = true;
  ...
  if (flag_close_valve3_in_progress && ret_sfm3000_1 == 0)
  {
    if(mFlow_1 >= 0.2)
    {
