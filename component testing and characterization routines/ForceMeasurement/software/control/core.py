...
class NavigationController(QObject):
    ...
    def __init__(self,microcontroller):
        ...
        self.file.write('Time (s), Actuator pos (open-loop), Force (N)')
    ...
    def collect_data(self):
        ...
        if data is not None:
            ...
            for i in range(int(MicrocontrollerDef.MSG_LENGTH/N_BYTES_PER_RECORD)):
                ...
                force_voltage = (Force.DRIVE_VOLTAGE)*(force_sensor_reading/Force.ADC_RESOLUTION)
                ...
                self.file.write(str(self.time_now) + ',' +str(stepper1_openLoop_pos)+','+str(force_newtons)+'\n')
