...
class WaveformDisplay(QFrame):
	...
	def __init__(self, main=None, *args, **kwargs):
		...
		self.row_idx = 0
		self.plots  = []
		# This was default addition and removed since we are integrating now
		# self.add_components()
		self.setFrameStyle(QFrame.Panel | QFrame.Raised)

	def add_components(self, gui_plots=None):

		plot_layout = QGridLayout()
		self.plot_grp_box = QGroupBox()
		r = 0
		if gui_plots is None:
			gui_plots = constants.__PLOTS__
		for dict_item in gui_plots:
			r = r+1
