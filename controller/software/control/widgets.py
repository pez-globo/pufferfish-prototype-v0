...
class NavigationWidget(QFrame):
    ...
    def add_components(self):
        ...
        self.entry_dY.setMaximum(65535)
        ...
        self.entry_dZ.setMaximum(65535) 
...
class ControlPanel(QFrame):
	...
	def add_components(self):
		...
		self.label_stepper_pos_air.setFrameStyle(QFrame.Panel | QFrame.Sunken)
		self.label_stepper_pos_air.setFixedWidth(50)
		self.label_stepper_pos_oxygen = QLabel()
		self.label_stepper_pos_oxygen.setFrameStyle(QFrame.Panel | QFrame.Sunken)
		self.label_stepper_pos_oxygen.setFixedWidth(50)
		...
		self.label_p_supply_air = QLabel()
		self.label_p_supply_air.setFrameStyle(QFrame.Panel | QFrame.Sunken)
		self.label_p_supply_air.setFixedWidth(50)
		self.label_p_supply_oxygen = QLabel()
		self.label_p_supply_oxygen.setFrameStyle(QFrame.Panel | QFrame.Sunken)
		self.label_p_supply_oxygen.setFixedWidth(50)
		...
		grid_line3.addWidget(QLabel('p supply oxygen (psi)'))
		grid_line3.addWidget(self.label_p_supply_oxygen)
		grid_line3.addWidget(QLabel('stepper pos air'))
		grid_line3.addWidget(self.label_stepper_pos_air)
		grid_line3.addWidget(QLabel('stepper pos oxygen'))
		grid_line3.addWidget(self.label_stepper_pos_oxygen)
		grid_line3.addWidget(QLabel('flow_air (slm)'))
		grid_line3.addWidget(self.label_flow_air)
		grid_line3.addWidget(QLabel('flow_oxygen (slm)'))
		grid_line3.addWidget(self.label_flow_oxygen)
		grid_line3.addWidget(QLabel('flow_proximal (slm)'))
		grid_line3.addWidget(self.label_flow_proximal)
		grid_line3.addWidget(QLabel('p exhalation control (cmH2O)'))
		...
		grid_line3.addWidget(QLabel('p aux (cmH2O)'))
		grid_line3.addWidget(self.label_p_aux)
		grid_line3.addWidget(QLabel('dP (Pa)'))
		grid_line3.addWidget(self.label_dP)
		grid_line3.addWidget(QLabel('FiO2 (%)'))
		grid_line3.addWidget(self.label_fio2)
