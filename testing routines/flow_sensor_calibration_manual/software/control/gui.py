...
class VentDevGUI(QMainWindow):
	...
	def __init__(self, *args, **kwargs):
		...
		self.waveforms.signal_dP_SDP31.connect(self.waveformDisplay.plotWidgets['dP SDP31'].update_plot)
		self.waveforms.signal_dP_SDP810.connect(self.waveformDisplay.plotWidgets['dP SDP810'].update_plot)
		self.waveforms.signal_dP_SM9336.connect(self.waveformDisplay.plotWidgets['dP SM9336'].update_plot)
		self.waveforms.signal_Flow1.connect(self.waveformDisplay.plotWidgets['Flow SFM3000'].update_plot)
