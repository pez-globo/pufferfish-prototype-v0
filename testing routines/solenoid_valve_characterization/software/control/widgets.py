...
class NavigationWidget(QFrame):
    ...
    def update_PWM(self):
        ...
        cmd[0] = int(self.entry_PWM_start.value()/256)
        cmd[1] = int(self.entry_PWM_start.value()%256)
    ...
    def cycle_PWM(self):
        ...
        cmd[0] = int(self.entry_PWM_start.value()/256)
        cmd[1] = int(self.entry_PWM_start.value()%256)
        cmd[2] = int(self.entry_PWM_end.value()/256)
        cmd[3] = int(self.entry_PWM_end.value()%256)
        cmd[4] = int(self.entry_PWM_step_increase.value()/256)
        cmd[5] = int(self.entry_PWM_step_increase.value()%256)
        cmd[6] = int(self.entry_PWM_step_decrease.value()/256)
        cmd[7] = int(self.entry_PWM_step_decrease.value()%256)
        cmd[8] = int(self.entry_PWM_max_hold.value()/256)
        cmd[9] = int(self.entry_PWM_max_hold.value()%256)
        cmd[10] = int(self.entry_PWM_min_hold.value()/256)
        cmd[11] = int(self.entry_PWM_min_hold.value()%256)
